...
OptimizerModuleBase::Node OptimizerModuleBase::nodeFromAST(const ::sqf::parser::sqf::impl_default::astnode& input) {
    ...
    case ::sqf::parser::sqf::impl_default::nodetype::ASSIGNMENTLOCAL: {
        ...
        newNode.file = input.path.physical;
    ...
    case ::sqf::parser::sqf::impl_default::nodetype::HEXNUMBER: {
        ...
        if (res.ec == std::errc::invalid_argument) {
            throw std::runtime_error("invalid scalar at: " + input.path.physical + ":" + std::to_string(input.line));
        }
        else if (res.ec == std::errc::result_out_of_range) {
            throw std::runtime_error("scalar out of range at: " + input.path.physical + ":" + std::to_string(input.line));
        }
